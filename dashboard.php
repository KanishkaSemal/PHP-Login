...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        <p class="logo">Bluechip<span> Technologies Asia</span></p>
        <a href="#" class="icon-a"><i class="fa fa-dashboard icons"></i>&nbsp;&nbsp;
        Dashboard</a>
        <a href="#" class="icon-a"><i class="fa fa-users icons"></i>&nbsp;&nbsp;
        Customer</a>
    ...
    <div id="main">
        <div class="head">
            ...
            <div class="col-div-6">
                 <div class="profile">
                 <img src="image/kanishka semal.png" class="pro-img">
                 <p>Kanishka Semal <span>Fullstack Developer</span></p>
                </div>
            </div>
